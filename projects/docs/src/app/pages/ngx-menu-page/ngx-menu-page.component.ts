...
export class NgxMenuPageComponent implements OnInit {
  ...
  transitionMenuSnippet = `<div ngx-menu #menu class="relative inline-block text-left">
  <div MenuButton>
  ...
  <div ngx-transition MenuItems [enterFrom]="'transform opacity-0 scale-95'" [enterTo]="'transform opacity-100 scale-100'" [enter]="'transition ease-out duration-100'" [leaveFrom]="'transform opacity-100 scale-100'" [leaveTo]="'transform opacity-0 scale-95'" [leave]="'transition ease-in duration-75'" [show]="menu.opened">
